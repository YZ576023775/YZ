...
public class MusicCrawlStart {
	 final static Logger logger = Logger.getLogger(MusicCrawlStart.class);
	 static int size;
	...
	public static void main(String[] args) {
		...
		Document document = null;
			try {
				document = reader.read(MusicCrawlStart.class.getClassLoader().getResourceAsStream("crawl_properties.xml"));
...
//			mr.setRootUrl("http://www.kuwo.cn");
//			mr.setThreadCount("10");
//			mr.setCrawDepth("4");
//			mr.setMax("200");
//			mr.setEncodeUrl("http://www\\.kuwo\\.cn/(artist|mingxing)/.*");
//			mr.setMusicUrlRgx("http://www\\.kuwo\\.cn/yinyue/.*(\\?catalog=.*)?");
//			mr.setMvUrlRgx("http://www\\.kuwo\\.cn/mv/.*/");
//			mr.setArtistUrlRgx("http://www\\.kuwo\\.cn/artist/content\\?name=.*||http://www\\.kuwo\\.cn/mingxing/.*/");
//			mr.setAlbumUrlRgx("http://www\\.kuwo\\.cn/album/.*/");
//			mr.setParseUrlRgx("a[href~=http://www\\.kuwo\\.cn.*]");
//			System.out.println(element.elementTextTrim("rootUrl").equals("http://www.kuwo.cn"));
//			System.out.println(element.elementTextTrim("threadCount").equals("10"));
//			System.out.println(element.elementTextTrim("crawDepth").equals("4"));
//			System.out.println(element.elementTextTrim("max").equals("200"));
//			System.out.println(element.elementTextTrim("encodeUrl").toString()+" and "+"http://www\\.kuwo\\.cn/(artist|mingxing)/.*"+element.elementTextTrim("encodeUrl").equals("http://www\\.kuwo\\.cn/(artist|mingxing)/.*"));
//			System.out.println(element.element("urlToolsRgx").elementTextTrim("MusicUrlRgx").equals("http://www\\.kuwo\\.cn/yinyue/.*(\\?catalog=.*)?"));
//			System.out.println(element.element("urlToolsRgx").elementTextTrim("MvUrlRgx").equals("http://www\\.kuwo\\.cn/mv/.*/"));
//			System.out.println(element.element("urlToolsRgx").elementTextTrim("ArtistUrlRgx").equals("http://www\\.kuwo\\.cn/artist/content\\?name=.*||http://www\\.kuwo\\.cn/mingxing/.*/"));
//			System.out.println(element.element("urlToolsRgx").elementTextTrim("AlbumUrlRgx").equals("http://www\\.kuwo\\.cn/album/.*/"));
//			System.out.println(element.elementTextTrim("ParseUrlRgx").equals("a[href~=http://www\\.kuwo\\.cn.*]"));
//			System.out.println();
...
//		UrlTools urlTools = new UrlTools(MusicUrlRgx, MvUrlRgx, ArtistUrlRgx, AlbumUrlRgx);
		...
		while (true) {
			if (wc.notCrawlurlSet.isEmpty()
				...
				synchronized (MusicCrawlStart.class) {

					MusicCrawlStart.exitCount++;
					if (MusicCrawlStart.exitCount == MusicCrawlStart.size) {
						System.exit(1);
					}else {
						break;
					}
