...
public final class ThreadGroup {
    private static Logger logger = Logger.getLogger(ThreadGroup.class);
    ...
    /* 单例 */
    private static ThreadGroup instance = ThreadGroup.getInstance();
    ...
    private ThreadGroup(int pool_worker_num) {
    ...
    public static synchronized ThreadGroup getInstance() {
        if (instance == null)
